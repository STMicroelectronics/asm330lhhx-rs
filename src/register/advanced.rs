use super::super::{
    Asm330lhhx, BusOperation, DelayNs, EmbAdvFunctions, Error, RegisterOperation, bisync,
    register::MainBank,
};
...
#[adv_register(base_address = AdvPage::_0, address = EmbAdvReg0::MagCfgA, access_type = "Asm330lhhx<B, T, MainBank>")]
...
/// * `Msb`: Most significant bit first.
/// * `Lsb`: Least significant bit first (default).
#[adv_register(base_address = AdvPage::_0, address = EmbAdvReg0::MagCfgB, access_type = "Asm330lhhx<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct MagCfgB {
...
#[adv_register(base_address = AdvPage::_0, address = EmbAdvReg0::MagSensitivityL, access_type = "Asm330lhhx<B, T, MainBank>")]
...
#[adv_register(base_address = AdvPage::_0, address = EmbAdvReg0::MagOffxL, access_type = "Asm330lhhx<B, T, MainBank>")]
pub struct MagOffXYZ(pub [i16; 3]);

/// XX XY XZ YY YZ ZZ
#[adv_register(base_address = AdvPage::_0, address = EmbAdvReg0::MagSiXxL, access_type = "Asm330lhhx<B, T, MainBank>")]
pub struct MagSiMatrix(pub [u16; 6]);

#[adv_register(base_address = AdvPage::_1, address = EmbAdvReg1::FsmLcTimeoutL, access_type = "Asm330lhhx<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u16, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u16, order = Lsb))]
...
#[adv_register(base_address = AdvPage::_1, address = EmbAdvReg1::FsmPrograms, access_type = "Asm330lhhx<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[adv_register(base_address = AdvPage::_1, address = EmbAdvReg1::FsmStartAddL, access_type = "Asm330lhhx<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u16, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u16, order = Lsb))]
...
#[adv_register(base_address = AdvPage::_1, address = EmbAdvReg1::MlcMagSensitivityL, access_type = "Asm330lhhx<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u16, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u16, order = Lsb))]
