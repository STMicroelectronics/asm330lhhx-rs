...
#[bisync]
impl<P, T> Asm330lhhx<i2c::I2cBus<P>, T, MainBank>
where
    P: I2c,
    T: DelayNs,
{
    ...
    /// * `address`: The I2C address of the Asm330lhhx sensor.
    ///
    /// # Returns
    ///
    /// * `Result`
    ///     * `Self`: Returns an instance of `Asm330lhhx`.
    ///     * `Err`: Returns an error if the initialization fails.
    pub fn new_i2c(i2c: P, address: I2CAddress, tim: T) -> Self {
        // Initialize the I2C bus with the Asm330lhhx address
...
#[bisync]
impl<P, T> Asm330lhhx<spi::SpiBus<P>, T, MainBank>
where
    P: SpiDevice,
    T: DelayNs,
{
...
#[bisync]
impl<B, T, S> MemBankFunctions<MemBank> for Asm330lhhx<B, T, S>
where
    B: BusOperation,
    T: DelayNs,
    S: BankState,
...
#[bisync]
impl<B: BusOperation, T: DelayNs> EmbAdvFunctions for Asm330lhhx<B, T, MainBank> {
    type Error = Error<B::Error>;
...
#[bisync]
impl<B: BusOperation, T: DelayNs, S: BankState> SensorOperation for Asm330lhhx<B, T, S> {
    type Error = Error<B::Error>;
...
#[bisync]
impl<B: BusOperation, T: DelayNs> Asm330lhhx<B, T, MainBank> {
    ...
    ///
    /// * `Result`
    ///     * `Asm330lhhxFsXl`: Get the values of fs_xl in reg CTRL1_XL.
    ///     * `Err`: Returns an error if the operation fails.
    ...
    /// # Arguments
    ///
    /// * `val`: Get registers ALL_INT_SRC; WAKE_UP_SRC; D6D_SRC;
    ///   STATUS_REG; EMB_FUNC_STATUS; FSM_STATUS_A/B.
    ///
    /// # Returns
    ///
    /// * `Result`
    ...
    /// Connect/Disconnect INT1 pull-down
    ///
    /// # Arguments
    ///
    /// * `val`: Change the vaules of pd_dis_int1 in reg I3C_BUS_AVB
    ///
    /// # Returns
    ///
    /// * `Result`
    ///     * `()`
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn int1_mode_set() -> Result<(), Error<B::Error>> {
        todo!();
    }
    ...
    ///
    /// * `Result`
    ///     * `PullDown`: Get the vaules of pd_dis_int1 in reg I3C_BUS_AVB
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn int1_mode_get() -> Result<(), Error<B::Error>> {
        todo!();
    }
    ...
    ///     * `()`
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn i3c_disable_set() -> Result<(), Error<B::Error>> {
        todo!();
    }

    /// Get the configuration for I3C communication protocol
    ///
    /// # Returns
    ///
    /// * `Result`
    ///     * `I3cDisable`
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn i3c_disable_get() -> Result<(), Error<B::Error>> {
        todo!();
    }
    ...
    pub async fn int_notification_get(&mut self) -> Result<Lir, Error<B::Error>> {
        ...
        self.operate_over_emb(async |state| {
            ...
            let val = (page_rw.emb_func_lir() << 1) + int_cfg0.lir();
    ...
    ///
    /// * `Result`
    ///     * `FsmStatus`: FSM_STATUS_A_MAINPAGE, FSM_STATUS_B_MAINPAGE
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn fsm_status_get() -> Result<(), Error<B::Error>> {
        todo!();
    }
    ...
    pub async fn emb_func_clk_dis_set() -> Result<u8, Error<B::Error>> {
        todo!("This function misses docs also on C")
    }

    pub async fn emb_func_clk_dis_get() -> Result<u8, Error<B::Error>> {
        todo!("This function misses docs also on C")
    }
    ...
    /// MLC initialization request
    ///
    /// # Arguments
    ///
    /// * `val`: Change the values of mlc_init
    ///
    /// # Returns
    ///
    /// * `Result`
    ///     * `()`
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn mlc_init_set() -> Result<(), Error<B::Error>> {
        todo!();
    }
    ...
    ///
    /// * `Result`
    ///     * `u8`: Values of mlc_init
    ///     * `Err`: Returns an error if the operation fails.
    pub async fn mlc_init_get() -> Result<(), Error<B::Error>> {
        todo!();
    }
